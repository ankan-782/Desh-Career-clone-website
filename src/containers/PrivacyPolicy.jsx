    ...
    return (
        <div className="container">
            <div className="space-y-6">
                <h2 className="text-5xl laptop:text-6xl font-semibold text-center laptop:text-start">Privacy Policy</h2>
                <p>
                    Effective date: April 04, 2023. Bangla Puzzle Limited ("us", "we", or "our") operates the www.deshcareer.com website (the "Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy for Desh Career is created.
                </p>
                <p>
                    We use your data to provide and improve the Service. By using the Service, you agree to this policy's collection and use of information. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from 
                    <span> <Link to="/" className="text-blue-700 underline">www.deshcareer.com</Link></span>
                </p>
                <p>
                ...
                <p>
                    Desh Career may disclose your Data in the good faith belief that such action is necessary to:
                </p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of
                        <Link to="https://www.banglapuzzle.com" target="_blank" rel="noopener">Bangla Puzzle</Link>
                    </li>
                ...
                <p>
                    If you have any questions about this Privacy Policy, please contact us: <Link to='mailto:contact.deshcareer@gmail.com' className="text-blue-700">contact.deshcareer@gmail.com</Link>
                </p>
                <p>&nbsp;</p>
            </div>
        </div>
