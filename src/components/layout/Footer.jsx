...
export default function Footer() {
    return (
        <footer className="bg-[#0f0d32] text-[#c2cdff] py-4">
            <div className="container">
                <div className="divide-y-2 divide-solid divide-slate-400">
                    <div className="py-8 grid grid-cols-1 tablet:grid-cols-3 tablet:gap-6 space-y-16 tablet:space-y-0 tablet:items-center">
                        <div className="grid grid-cols-1 gap-8 place-items-center tablet:place-items-start">
                            <img className="w-56" src="/src/assets/logo.png" alt="logo" />
                            <p className="text-center tablet:text-left max-w-[45ch] tablet:max-w-fit">Desh Career is Career based newsletter in Bengali language. This newsletter has published weekly. This is published in every Saturday at 12.00 PM. </p>
                            <ul className="flex gap-4 items-center" role="list" aria-label="social links">
                                ...
                                <li className="hover:text-slate-400 transition-colors">
                                    <Link aria-label="linkedin" href="https://www.linkedin.com/company/deshcareer/">
                                        <svg className="social-icon">
                        ...
                        <div className="space-y-8 text-center tablet:text-right">
